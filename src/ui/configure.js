...
<body>
  ...
  (function() {
    ...
    function buildUrl() {
      ...
      urlBox.value = url;
      var manifestUrl = url;
      var encoded = encodeURIComponent(manifestUrl);
      var hostPath = manifestUrl.replace(/^https?:\/\//, '');
      installApp.setAttribute('href', 'stremio://' + hostPath);
      installWeb.setAttribute('href', 'https://web.stremio.com/#/addons?addon=' + encoded);
    }
